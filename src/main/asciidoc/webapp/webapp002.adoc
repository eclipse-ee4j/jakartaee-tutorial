...
Examples are GlassFish, Open Liberty and WildFly.
...
One example is Tomcat.
It does implement Jakarta Servlet, Jakarta Pages, Jakarta WebSocket, Jakarta Expression Language and Jakarta Security.

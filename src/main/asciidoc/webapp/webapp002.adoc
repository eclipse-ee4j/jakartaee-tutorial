...
. Compile the web application components and helper classes referenced
by the components.
...
* `hello1`, a Jakarta Faces technology–based application that uses two
XHTML pages and a managed bean

...
link:interceptors/interceptors.html#GKEED[Chapter 57, "Using Jakarta EE Interceptors"].
...
link:cdi-adv-examples/cdi-adv-examples005.html#GKHRQ[The LoggedInterceptor Interceptor
Class].

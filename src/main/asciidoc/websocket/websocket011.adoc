...
in the timeout method. See link:ejb-basicexamples/ejb-basicexamples005.html#BNBOY[Using the
Timer Service] in link:ejb-basicexamples/ejb-basicexamples.html#GIJRB[Chapter 37, "Running

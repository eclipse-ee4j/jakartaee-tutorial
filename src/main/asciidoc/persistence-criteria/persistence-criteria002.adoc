...
Use the Metamodel API to create a metamodel of the managed entities in
a particular persistence unit. For each entity class in a particular
...
the managed entity classes and their persistent state and
relationships.

=== Using Metamodel Classes

Metamodel classes that correspond to entity classes are of the
following type:

...
link:jsf-page/jsf-page-core001.html#BNAST[Using the Standard Converters] for more
information on these included converters.

As explained in link:jsf-intro/jsf-intro005.html#BNAQI[Conversion Model], if the
...
data described in link:jsf-intro/jsf-intro005.html#BNAQI[Conversion Model].
...
link:jsf-configure/jsf-configure009.html#BNAXE[Registering a Custom Converter].

...
component is the responsibility of the `jakarta.faces.render.Renderer`.
...
See link:#BNAVK[Component, Renderer, and Tag
...
application. See link:#GLNVI[Chapter 60, "Duke's

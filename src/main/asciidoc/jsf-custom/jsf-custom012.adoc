...
link:jsf-intro/jsf-intro005.html#BNAQK[Validation Model], there are two ways to
...
link:jsf-develop/jsf-develop003.html#BNAVE[Writing a Method to Perform Validation]
...
link:jsf-develop/jsf-develop002.html#BNAUL[Writing Properties Bound to Converters,

...
in link:jsf-custom/jsf-custom006.html#BNAWA[Delegating Rendering to a Renderer], you
...
annotation, as described in link:jsf-custom/jsf-custom006.html#BNAWB[Creating the

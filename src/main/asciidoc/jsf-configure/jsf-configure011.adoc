...
in link:#BNAWA[Delegating Rendering to a Renderer], you
...
annotation, as described in link:#BNAWB[Creating the
...
`jakarta.faces.render.Renderer` implementation. By nesting the `renderer`

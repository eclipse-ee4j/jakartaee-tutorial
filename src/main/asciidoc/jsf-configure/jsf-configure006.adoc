...
A Jakarta Faces page uses the `message` or `messages` tags to access
error messages, as explained in
...
https://jakarta.ee/specifications/faces/3.0/jakarta-faces-3.0.html#a584[Section
2.5.2.4^] of the Jakarta Faces specification for a complete list of

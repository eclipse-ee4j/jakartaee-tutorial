...
For more information on defining styles, see the Cascading Style Sheets specifications and drafts at http://www.w3.org/Style/CSS/[^].
...
.Example Components for Selecting One Item
image::jakartaeett_dt_067_slctn.png["Options, check box, and lists."]

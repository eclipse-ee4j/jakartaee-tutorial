...
link:jms-concepts/jms-concepts005.html#BNCGL[Using Jakarta Messaging in Jakarta EE
...
link:jms-concepts/jms-concepts003.html#BNCEW[Message Bodies].
...
consumer. (See link:jms-concepts/jms-concepts002.html#BNCED[Publish/Subscribe
Messaging Style] and link:jms-concepts/jms-concepts003.html#BABEEJJJ[Consuming
...
link:jms-concepts/jms-concepts003.html#BNCEY[JMS Queue Browsers]. This section then
...
link:jms-concepts/jms-concepts004.html#BNCFW[Controlling Message Acknowledgment].

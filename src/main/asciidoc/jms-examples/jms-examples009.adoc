...
[[an-enterprise-bean-application-client-to-message-driven-beans-to-entity]]
image::jakartaeett_dt_038.png["Diagram of application showing an application client, two message-driven beans, and an entity, as well as the associated topic and queue",title="An Enterprise Bean Application: Client to Message-Driven Beans to Entity"]

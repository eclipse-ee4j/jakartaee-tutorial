...
section link:ejb-intro/ejb-intro003.html#GIPKO[What Is a Message-Driven Bean?] as
well as link:jms-concepts/jms-concepts005.html#BNCGQ[Using Message-Driven Beans to
...
link:jms-concepts/jms-concepts005.html#BNCGQ[Using Message-Driven Beans to Receive
...
See link:jms-concepts/jms-concepts005.html#GJKOH[Table 48-3] for a list of the

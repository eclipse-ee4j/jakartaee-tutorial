...
The source code for this application is in the `_tut-install_/examples/web/faces/simple-flow/` directory.
...
+
----
tut-install/examples/web/faces/simple-flow/
----
...
The source code for this application is in the `_tut-install_/examples/web/faces/checkout-module/` directory.
...
+
----
tut-install/examples/web/faces/checkout-module/
----

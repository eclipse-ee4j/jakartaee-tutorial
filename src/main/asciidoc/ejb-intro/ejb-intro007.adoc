...
image::jakartaeett_dt_021.png["Diagram showing the lifecycle of a stateful session bean.",title="Lifecycle of a Stateful Session Bean"]
...
image::jakartaeett_dt_022.png["Diagram showing the lifecycle of a stateless or singleton session bean.", title="Lifecycle of a Stateless or Singleton Session Bean"]
...
[[lifecycle-of-a-message-driven-bean]]
image::jakartaeett_dt_023.png["Diagram showing the lifecycle of a message-driven bean.",title="Lifecycle of a Message-Driven Bean"]

...
First, the client can access a web service created with Jakarta XML Web Services (For more information on Jakarta XML Web Services, see xref:building-web-services-with-jakarta-xml-web-services[xrefstyle=full].).

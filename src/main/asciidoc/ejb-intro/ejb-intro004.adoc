...
image::jakartaeett_dt_020.png["Diagram showing a remote client accessing an enterprise bean's methods through its remote interface.",title="Interfaces for an Enterprise Bean with Remote Access"]

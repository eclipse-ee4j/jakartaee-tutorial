...
The `address-book` application uses a Jakarta Faces web front end to
allow users to enter contacts. While Jakarta Faces has a form input
...
Jakarta Faces managed beans, in this case in the `Contact` entity,
...
messages. The form doesn't require any Jakarta Faces validation tags,
however.

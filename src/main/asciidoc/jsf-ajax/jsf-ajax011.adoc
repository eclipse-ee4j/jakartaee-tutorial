...
example from link:jsf-facelets/jsf-facelets.html#GIEPX[Chapter 8, "Introduction to
...
You will learn more about CDI in link:cdi-basic/cdi-basic.html#GIWHB[Chapter 25,

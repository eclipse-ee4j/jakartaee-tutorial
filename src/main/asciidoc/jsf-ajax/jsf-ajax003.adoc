...
|`disabled` |`jakarta.el.ValueExpression` that evaluates to a `Boolean` |A
...
|`execute` |`jakarta.el.ValueExpression` that evaluates to an `Object` |A
...
|`immediate` |`jakarta.el.ValueExpression` that evaluates to a `Boolean`
...
method that is called when a `jakarta.faces.event.AjaxBehaviorEvent` has
been broadcast for the listener.

|`onevent` |`jakarta.el.ValueExpression` that evaluates to a `String` |The
name of the JavaScript function that handles UI events.

|`onerror` |`jakarta.el.ValueExpression` that evaluates to a `String` |The
name of the JavaScript function that handles errors.

|`render` |`jakarta.el.ValueExpression` that evaluates to an `Object` |A

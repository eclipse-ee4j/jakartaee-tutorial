...
It is similar to the `guessnumber-faces` example described in xref:introduction-to-facelets[xrefstyle=full], except that you can keep guessing until you get the right answer or until you use up your ten attempts.

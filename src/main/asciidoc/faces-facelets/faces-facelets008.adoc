...
The `hello1-rlc` example modifies the simple `hello1` example from <<a-web-module-that-uses-jakarta-faces-technology-the-hello1-example>> to use two resource library contracts.
...
The source code for this application is in the `_tut-install_/examples/web/faces/hello1-rlc/` directory.
...
+
----
tut-install/examples/web/faces/hello1-rlc/
----

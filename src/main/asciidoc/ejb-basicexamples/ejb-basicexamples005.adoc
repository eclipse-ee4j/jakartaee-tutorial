...
contains a method annotated with the `jakarta.ejb.Schedule` or
...
`jakarta.ejb.ScheduleExpression` object, passed as a parameter to the
...
documentation at
`https://jakarta.ee/specifications/platform/8/apidocs/jakarta.ejb/TimerService.html`.

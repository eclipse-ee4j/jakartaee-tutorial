...
link:persistence-intro/persistence-intro.html#BNBPZ[Chapter 40, "Introduction to the Jakarta
...
Properties] and link:bean-validation/bean-validation-advanced.html#GKAHP[Chapter 24,
...
link:cdi-adv/cdi-adv005.html#GKHIC[Using Events in CDI Applications].
...
link:websocket/websocket.html#GKJIQ5[Chapter 19, "Jakarta WebSocket."] For
information on CDI events, see link:cdi-adv/cdi-adv005.html#GKHIC[Using Events in
CDI Applications].

...
Use the `jakarta.inject.Inject` annotation to inject managed beans; for
example:
...
<<introduction-to-jakarta-contexts-and-dependency-injection>> and the
Jakarta Contexts and Dependency Injection spec.
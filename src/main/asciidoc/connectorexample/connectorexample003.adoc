...
|`jakarta.resource.spi` |`ResourceAdapter` |Defines the lifecycle methods
...
|`jakarta.resource.spi` |`Work` |The traffic service subscriber implements
...
`jakarta.resource.spi.Work` interface from the work management contract.

...
image::jakartaeett_dt_056.svg["This figure shows the components of the traffic example: a WAR communicating with an enterprise bean using a JMS topic, and a RAR communicating with an EIS over a TCP socket.",title="The traffic Example"]
...
image::jakartaeett_dt_057.svg["This figure shows the classes in each of the components of the traffic example.",title="Architecture of the traffic Example"]

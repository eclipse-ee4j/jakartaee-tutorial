...
can then be used by an application, such as a Jakarta Faces
...
needs to be understood. In addition, for a Jakarta Faces
...
to understand what can be injected and in what context. Faces 2.3 and
above provides producers that enable most important Faces artifacts to
be injected. For detailed information, see the package

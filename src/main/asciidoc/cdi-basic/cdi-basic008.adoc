...
servlet, including Jakarta Faces applications. The conversation scope
...
Dependency Injection and the Jakarta Faces specification. The last two
are defined by Jakarta Context and Dependency Injection.

...
link:usingexamples/usingexamples007.html#CHDJGCCA[Installing the Tutorial Archetypes].
...
link:jaxrs-client/jaxrs-client002.html#BABEDFIG["The Client API in the rsvp Example
Application"].

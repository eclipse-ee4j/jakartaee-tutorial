...
link:#GINPW[The @Path Annotation and URI Path Templates] for
more information.
...
link:#GIPYS[Responding to HTTP Methods and Requests] for
more information.
...
control. See link:#GIPYS[Responding to HTTP Methods and
Requests] and link:#GIPZE[Using Entity Providers to Map HTTP
...
link:#GIPZE[Using Entity Providers to Map HTTP Response and
Request Entity Bodies] and link:#GIPZE[Extracting Request Parameters] in the Jakarta REST Overview

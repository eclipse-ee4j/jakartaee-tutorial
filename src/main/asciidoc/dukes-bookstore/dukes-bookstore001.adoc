...
Jakarta Server Faces technology, in addition to other Jakarta EE
features:

* Jakarta Server Faces technology, as well as Jakarta Contexts and
...
Jakarta Server Faces managed bean. Text hyperlinks are also provided
for accessibility.

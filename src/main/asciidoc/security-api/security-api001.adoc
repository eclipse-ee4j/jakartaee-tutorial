...
* The `jakarta.security.enterprise` package is the main Jakarta Security package
...
* The `jakarta.security.enterprise.authentication.mechanism.http` package contains
...
* The `jakarta.security.enterprise.credential` package contains classes and
...
* The `jakarta.security.enterprise.identitystore` package contains classes and
...
*Table 51-1  Main Classes and Interfaces in jakarta.security.enterprise*
...
*Table 51-2 Main Classes and Interfaces in jakarta.security.enterprise.authentication.mechanism.http*
[width="99%",cols="25%,75%"]
|=======================================================================
|*Class or Interface* |*Description*
...
a|
*Note:*
The `jakarta.security.enterprise.authentication.mechanism.http` package also includes
...
*Table 51-3 Main Classes and Interfaces in jakarta.security.enterprise.credential*
[width="99%",cols="25%,75%"]
|=======================================================================
|*Class or Interface* |*Description*
...
*Table 51-4 Main Classes and Interfaces in jakarta.security.enterprise.identitystore*
[width="99%",cols="25%,75%"]
|=======================================================================
|*Class or Interface* |*Description*

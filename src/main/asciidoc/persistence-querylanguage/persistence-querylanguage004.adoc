...
you can quickly move on to <<example-queries>>. When you are ready to
learn about the syntax in more detail, see
...
updated or deleted. The `WHERE` clause may be used to restrict the
scope of the update or delete operation.

...
[[responding-to-a-client-request-for-a-jakarta-server-faces-page]]
image::jakartaeett_dt_014.png["Diagram that shows a browser accessing the myfacelet.xhtml page using an HTTP Request and the server sending the rendered HTML page using an HTTP Response.", title="Responding to a Client Request for a Jakarta Server Faces Page"]

...
image::jakartaeett_dt_006.png["Diagram of Jakarta EE containers and their relationships", title="Jakarta EE Containers"]

<<jakarta-ee-apis-in-the-web-container>> shows the availability of the
Jakarta EE APIs in the web container.

[[jakarta-ee-apis-in-the-web-container]]
image::jakartaeett_dt_007.png["Diagram of Jakarta EE APIs in the web container", title="Jakarta EE APIs in the Web Container"]
...
image::jakartaeett_dt_008.png[ "Diagram of Jakarta EE APIs in the enterprise bean container"y, title="Jakarta EE APIs in the enterprise bean Container"]
...
image::jakartaeett_dt_009.png["Diagram of Jakarta EE APIs in the application client container", title="Jakarta EE APIs in the Application Client Container"]
////

...
[[jakarta-ee-server-and-containers]]
image::jakartaeett_dt_005.png["Diagram of client-server communication showing servlets and web pages in the web tier and enterprise beans in the business tier.", title="Jakarta EE Server and Containers"]

...
Jakarta Faces technology offers the concept of composite components
...
see the Jakarta Faces Facelets Tag Library documentation.
...
`inputText` component. The word `cc` in Jakarta Faces is a reserved
word for composite components. The `#{cc.attrs._attribute-name_}`
...
directory. This directory is considered a library by Jakarta Faces, and
a component can be accessed from such a library. For more information

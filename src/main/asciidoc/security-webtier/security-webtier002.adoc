...
image::jakartaeett_dt_045.png["Diagram of four steps in HTTP basic authentication between client and server",title="HTTP Basic Authentication"]
...
image::jakartaeett_dt_046.png["Diagram of four steps in form-based authentication between client and server",title="Form-Based Authentication"]

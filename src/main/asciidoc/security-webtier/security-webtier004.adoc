...
Jakarta Server Faces application. With form-based authentication, you
can customize the login screen and error pages that are presented to
the web client for authentication of the user name and password. When a
...
Server Faces application shown in
...
an unsecured Jakarta Server Faces application are similar to those
described in
<<the-hello2-basicauth-example-basic-authentication-with-a-servlet>>.

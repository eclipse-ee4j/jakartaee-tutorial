...
link:bean-validation-advanced/bean-validation-advanced004.html#CIHGJBGI[Using Method Constraints
...
----
In this sample, `@Email` is an in-built constraint supported by Bean Validation, and `@USPhoneNumber` is a user-defined constraint. See link:bean-validation-advanced/bean-validation-advanced001.html#GKAIA[Using the Built-In Constraints to Make a New Constraint].
...
See link:bean-validation-advanced/bean-validation-advanced001.html#CIHCICAI[Removing Ambiguity in

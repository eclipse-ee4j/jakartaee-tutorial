...
link:bean-validation-advanced/bean-validation-advanced001.html#GKFGX[Creating Custom Constraints]
...
* link:bean-validation-advanced/bean-validation-advanced.html#GKAHP[Chapter 24, "Jakarta Bean Validation:
Advanced Topics"]
* link:jaxrs/jaxrs-advanced002.html#BABCJEDF[Validating Resource Data with Jakarta Bean
Validation]

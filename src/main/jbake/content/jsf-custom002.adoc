...
target browser, but none of the standard Jakarta Faces components
...
component architecture, you can use Jakarta Faces technology to
...
|Custom Jakarta Faces tag |Some server-side object, like a component,

type=page
status=published
title=Managed Beans in Jakarta Faces Technology
...
A typical Jakarta Faces application includes one or more managed
...
link:jsf-page.html#BNAQZ[Chapter 10, "Using Jakarta Faces Technology
...
validators. Developing a Jakarta Faces application also involves the

...
component is a significant task (see link:jsf-custom/jsf-custom.html#BNAVG[Chapter
...
and `name` value is `total`. See link:jsf-ajax/jsf-ajax.html#GKIOW[Chapter 13,

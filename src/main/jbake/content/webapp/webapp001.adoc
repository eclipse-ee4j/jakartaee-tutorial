...
covered in link:jsf-intro/jsf-intro.html#BNAPH[Chapter 7, "Jakarta Server Faces
Technology,"] through link:servlets/servlets.html#BNAFD[Chapter 18, "Jakarta Servlet
Technology."]
...
link:jaxws/jaxws.html#BNAYL[Chapter 31, "Building Web Services with JAX-WS,"]
and link:jaxrs/jaxrs.html#GIEPU[Chapter 32, "Building RESTful Web Services with

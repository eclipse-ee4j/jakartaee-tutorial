...
The tags included in the Jakarta Faces core tag library are used to
...
|`f:ajax` a|
link:jsf-ajax.html#GKIOW[Chapter 13, "Using Ajax with Jakarta Faces
Technology"]

|`f:websocket` a|
link:jsf-ws.html#using-websockets-with-javaserver-faces-technology[Chapter 17, "Using WebSockets with Jakarta Faces Technology"]

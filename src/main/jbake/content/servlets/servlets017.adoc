...
See link:ejb-basicexamples/ejb-basicexamples005.html#BNBOY[Using the Timer Service] in
...
See link:websocket/websocket011.html#BABGCEHE[The dukeetf2 Example Application] in
link:websocket/websocket.html#GKJIQ5[Chapter 19, "Jakarta WebSocket"] for an

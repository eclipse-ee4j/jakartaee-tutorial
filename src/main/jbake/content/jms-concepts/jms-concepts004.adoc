...
The sample program in link:jms-examples/jms-examples003.html#BNCFX[Acknowledging
...
For an example, see link:jms-examples/jms-examples009.html#BNCHF[Using an Entity to
...
The example in link:jms-examples/jms-examples004.html#BNCGJ[Using Local Transactions]

...
annotation registers the components with the Jakarta Faces
implementation:
...
The Jakarta Faces implementation automatically invokes the
...
During the Apply Request Values phase, the Jakarta Faces
...
Nearly all the attributes of the standard Jakarta Faces tags can
...
View phase, during which the Jakarta Faces implementation checks

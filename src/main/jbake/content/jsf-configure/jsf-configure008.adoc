...
link:jsf-custom/jsf-custom012.html#BNAUX[Implementing the Validator Interface], or
...
link:jsf-custom/jsf-custom012.html#BNATV[Using a Custom Validator] explains how to

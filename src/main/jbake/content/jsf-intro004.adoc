type=page
status=published
title=A Simple Jakarta Faces Application
...
Jakarta Faces technology provides an easy and user-friendly process
for creating web applications. Developing a simple Jakarta Faces
...
Jakarta Faces Technology: The hello1 Example]:
...
"Expression Language"]. For details on the Jakarta Faces programming
model and building web pages using Jakarta Faces technology, see

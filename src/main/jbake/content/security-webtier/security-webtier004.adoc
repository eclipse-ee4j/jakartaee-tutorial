...
with a Jakarta Server Faces Application]
...
* link:security-jakartaee/security-jakartaee003.html#BNBZK[The cart-secure Example: Securing an
Enterprise Bean with Declarative Security]
* link:security-jakartaee/security-jakartaee003.html#BNCAA[The converter-secure Example:
Securing an Enterprise Bean with Programmatic Security]
* Java EE 8 GlassFish samples: `https://javaee.github.io/glassfish-samples/`
...
chapter and in link:security-jakartaee/security-jakartaee.html#BNBYK[Chapter 52, "Getting
...
more in link:security-intro/security-intro005.html#BNBXR[Managing Users and Groups in
GlassFish Server].
+
[width="100%",cols="100%",]
|=======================================================================
...
in link:webapp/webapp.html#BNADR[Chapter 6, "Getting Started with Web
Applications"].
...
Faces application shown in link:webapp/webapp003.html#BNADX[A Web Module That

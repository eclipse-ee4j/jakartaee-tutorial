...
See xref:web:webapp/webapp.adoc#_getting_started_with_web_applications[Getting Started with Web Applications] for more information on running `.xhtml` files and their backing beans.

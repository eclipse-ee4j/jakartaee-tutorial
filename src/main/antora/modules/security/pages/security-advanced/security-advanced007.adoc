[[GKHRL]][[_configuring_security_using_deployment_descriptors]]
...
[[BNCCM]][[_specifying_security_for_basic_authentication_in_the_deployment_descriptor]]
...
[[GKAFQ]][[_specifying_non_default_principal_to_role_mapping_in_the_deployment_descriptor]]

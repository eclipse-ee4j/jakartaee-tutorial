[[BNBYB]][[_working_with_digital_certificates]]
...
section, xref:security-advanced/security-advanced.adoc#BNBYC[Creating a Server Certificate], to set up a digital
...
[[BNBYC]][[_creating_a_server_certificate]]
...
[[GJRGY]][[_to_use_keytool_to_create_a_server_certificate]]
...
[[GLIFW]][[_adding_users_to_the_certificate_realm]]
...
[[BNBYF]][[_using_a_different_server_certificate_with_glassfish_server]]

=== Using a Different Server Certificate with GlassFish Server

Follow the steps in xref:security-advanced/security-advanced.adoc#BNBYC[Creating a Server Certificate] to create
...
[[sthref230]][[_to_specify_a_different_server_certificate]]

[[GLIFD]][[_securing_enterprise_information_systems_applications]]
...
[[BABBJHIC]][[_overview_of_securing_enterprise_information_systems_applications]]
...
xref:security-advanced/security-advanced.adoc#GLIGS[Configuring Resource Adapter Security].

[[GLIHL]][[_container_managed_sign_on]]
...
[[GLIDP]][[_component_managed_sign_on]]
...
[[GLIGS]][[_configuring_resource_adapter_security]]
...
[[GLIGW]][[_mapping_an_application_principal_to_eis_principals]]

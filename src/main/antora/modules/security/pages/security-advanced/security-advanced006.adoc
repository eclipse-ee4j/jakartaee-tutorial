...
+
For more information on the implementation of the security permission specification, see the security policy file documentation listed in <<_further_information_about_advanced_security_topics>>.

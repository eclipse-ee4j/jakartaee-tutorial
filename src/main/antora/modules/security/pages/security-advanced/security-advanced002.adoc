[[GLIEN]][[_authentication_mechanisms]]
...
image::common:jakartaeett_dt_048.png["Diagram of six steps in mutual authentication with certificates"]
...
image::common:jakartaeett_dt_049.png["Diagram of five steps in mutual authentication with user name andpassword"]

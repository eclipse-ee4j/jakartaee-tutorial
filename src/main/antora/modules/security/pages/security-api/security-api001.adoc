[[_about_the_jakarta_ee_security_api]]
...
identity concerns. xref:security-api/security-api.adoc#_main_classes_and_interfaces_in_enterprise[Table 51-1] lists
...
xref:security-api/security-api.adoc#_main_classes_and_interfaces_in_authentication[Table 51-2] lists the main classes
and interfaces in this package.

* The `javax.javax.security.enterprise.credential` package contains classes and
interfaces for representing user credentials. xref:security-api/security-api.adoc#_main_classes_and_interfaces_in_credential[Table 51-3]
...
and lookup caller groups. xref:security-api/security-api.adoc#_main_classes_and_interfaces_in_identitystore[Table 51-4]
lists the main classes and interfaces in this package.

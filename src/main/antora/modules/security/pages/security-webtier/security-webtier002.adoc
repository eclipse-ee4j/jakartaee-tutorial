...
image::common:jakartaeett_dt_045.png["Diagram of four steps in HTTP basic authentication between client andserver"]
...
image::common:jakartaeett_dt_046.png["Diagram of four steps in form-based authentication between client andserver"]

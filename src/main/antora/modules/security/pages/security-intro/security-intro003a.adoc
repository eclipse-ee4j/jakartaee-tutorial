...
* xref:security-intro/security-intro.adoc#_jsr_196_java_authentication_service_provider_interface_for_containers_jaspic[JSR-196 Java
Authentication Service Provider Interface for Containers (JASPIC)]
* xref:security-intro/security-intro.adoc#_jsr_375_jakarta_ee_security_api[JSR-375 Jakarta EE Security API]

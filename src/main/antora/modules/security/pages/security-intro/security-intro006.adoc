...
Secure Sockets Layer (SSL) technology is security that is implemented at the transport layer (see <<_transport_layer_security>> for more information about transport-layer security).

[[BNBXW]][[_establishing_a_secure_connection_using_ssl]]

== Establishing a Secure Connection Using SSL

Secure Sockets Layer (SSL) technology is security that is implemented at
the transport layer (see
xref:security-intro/security-intro.adoc#BNBXC[Transport-Layer Security] for more
...
[[BNBXX]][[_verifying_and_configuring_ssl_support]]

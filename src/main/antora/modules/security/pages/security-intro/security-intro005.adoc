[[BNBXJ]][[_working_with_realms_users_groups_and_roles]]
...
image::common::common:jakartaeett_dt_044.png["Diagram of role mapping, showing creation of users and groups, definition of roles, and mapping of roles to users and groups"]

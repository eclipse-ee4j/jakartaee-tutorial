...
Declarative Security]. xref:security-webtier/security-webtier.adoc#BNCAS[Chapter 51,
...
xref:security-intro/security-intro.adoc#BNBYJ[Further Information about Security].
...
* xref:security-webtier/security-webtier.adoc#GJIIE[Using Programmatic Security with
Web Applications]
* xref:security-jakartaee/security-jakartaee.adoc#GJGCS[Securing an Enterprise Bean
Programmatically]

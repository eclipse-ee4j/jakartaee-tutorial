[[BNBWK]][[_overview_of_jakarta_ee_security]]
...
image::common::common:jakartaeett_dt_039.png["Diagram of initial request from web client to web server for access to aprotected resource"]
...
image::common::common:jakartaeett_dt_040.png["Diagram of initial authentication: server sends form to client, whichsends authentication data to server for validation"]
...
image::common::common:jakartaeett_dt_041.png["Diagram of URL authorization"]
...
image::common::common:jakartaeett_dt_042.png["Diagram of request fulfillment, showing server returning result to client"]
...
image::common::common:jakartaeett_dt_043.png["Diagram of authorization process between web component and enterprise bean"]

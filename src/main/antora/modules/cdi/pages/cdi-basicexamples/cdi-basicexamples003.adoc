...
It is similar to the `guessnumber-jsf` example described in xref:introduction-to-facelets[], except that you can keep guessing until you get the right answer or until you use up your ten attempts.

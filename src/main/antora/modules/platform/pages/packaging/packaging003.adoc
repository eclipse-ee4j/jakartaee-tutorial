...
The structure of a web module that can be deployed on GlassFish Server is shown in <<_web_module_structure>>.

[[_web_module_structure]]
.Web Module Structure
image::common:jakartaeett_dt_012.svg["Diagram of web module structure. WEB-INF and web pages are under the root. Under WEB-INF are descriptors and the lib and classes directories."]

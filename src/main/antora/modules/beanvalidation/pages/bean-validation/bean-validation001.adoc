...
Validation of data can take place at different layers in even the simplest of applications, as shown in xref:web:jsf-facelets/jsf-facelets.adoc#_developing_a_simple_facelets_application_the_guessnumber_jsf_example_application[Developing a Simple Facelets Application: The guessnumber-jsf Example Application].

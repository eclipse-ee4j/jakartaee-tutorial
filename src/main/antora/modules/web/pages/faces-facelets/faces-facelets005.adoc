...
This directory is considered a library by Jakarta Faces, and a component can be accessed from such a library. For more information on resources, see xref:faces-facelets/faces-facelets.adoc#_web_resources[Web Resources].

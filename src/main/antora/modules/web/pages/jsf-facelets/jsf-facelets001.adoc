...
For details, see xref:jsf-facelets/jsf-facelets.adoc#_html5_friendly_markup[HTML5-Friendly Markup].

Facelets supports tags for composite components, for which you can declare custom prefixes.
For more information on composite components, see xref:jsf-facelets/jsf-facelets.adoc#_composite_components[Composite Components].

[[BABHAHDF]][[_resource_library_contracts]]
...
[[sthref32]][[_the_hello1_rlc_example_application]]

=== The hello1-rlc Example Application

The `hello1-rlc` example modifies the simple `hello1` example from
xref:webapp/webapp.adoc#BNADX[A Web Module That Uses Jakarta Server Faces
...
[[BABGEDEB]][[_configuring_the_hello1_rlc_example]]
...
[[BABDHCFG]][[_the_facelets_pages_for_the_hello1_rlc_example]]
...
[[BABBGFFF]][[_to_build_package_and_deploy_the_hello1_rlc_example_using_netbeans_ide]]
...
[[BABJAGFB]][[_to_build_package_and_deploy_the_hello1_rlc_example_using_maven]]
...
[[BABFCHEB]][[_to_run_the_hello1_rlc_example]]

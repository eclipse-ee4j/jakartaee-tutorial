[[BABGECCJ]][[_html5_friendly_markup]]
...
component is a significant task (see xref:jsf-custom/jsf-custom.adoc#BNAVG[Chapter
...
[[sthref33]][[_using_pass_through_elements]]
...
xref:jsf-facelets/jsf-facelets.adoc#BABJADGH[Table 8-4] shows how pass-through elements are rendered
...
[[sthref35]][[_using_pass_through_attributes]]
...
[[BABGGIAA]][[_the_reservation_example_application]]
...
[[BABGCAHH]][[_the_facelets_pages_for_the_reservation_application]]
...
(as described in xref:jsf-facelets/jsf-facelets.adoc#BABHGBJI[Relocatable
Resources]):
...
and `name` value is `total`. See xref:jsf-ajax/jsf-ajax.adoc#GKIOW[Chapter 13,
...
[[BABHFCCG]][[_the_managed_bean_for_the_reservation_application]]
...
[[BABIHHGC]][[_to_build_package_and_deploy_the_reservation_example_using_netbeans_ide]]
...
[[sthref36]][[_to_build_package_and_deploy_the_reservation_example_using_maven]]
...
[[sthref37]][[_to_run_the_reservation_example]]

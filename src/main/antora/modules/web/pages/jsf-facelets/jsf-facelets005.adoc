...
xref:jsf-facelets/jsf-facelets.adoc#GJCWC[Table 8-3] lists the most commonly used composite tags and
their functions.
...
information on resources, see xref:jsf-facelets/jsf-facelets.adoc#GIRGM[Web
Resources].
...
See xref:jsf-advanced-cc/jsf-advanced-cc.adoc#GKHXA[Chapter 14, "Composite Components:

...
The section xref:jsf-custom/jsf-custom.adoc#_using_a_custom_component[Using a Custom Component] discusses how to use the custom component in a Jakarta Faces page.

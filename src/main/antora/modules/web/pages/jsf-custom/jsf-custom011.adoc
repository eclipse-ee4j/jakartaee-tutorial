[[BNAUS]][[_creating_and_using_a_custom_converter]]
...
xref:jsf-page-core/jsf-page-core.adoc#BNAST[Using the Standard Converters] for more
information on these included converters.

As explained in xref:jsf-intro/jsf-intro.adoc#BNAQI[Conversion Model], if the
...
data described in xref:jsf-intro/jsf-intro.adoc#BNAQI[Conversion Model].
...
[[GLPHB]][[_creating_a_custom_converter]]
...
xref:jsf-configure/jsf-configure.adoc#BNAXE[Registering a Custom Converter].
...
[[BNATU]][[_using_a_custom_converter]]
...
the fully-qualified class name of the converter. xref:jsf-custom/jsf-custom.adoc#BNAUS[Creating

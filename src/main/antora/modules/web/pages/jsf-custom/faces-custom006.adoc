...
The section xref:jsf-custom/jsf-custom.adoc#_performing_encoding[Performing Encoding] explains how `MapRenderer` performs the encoding for `MapComponent`.
...
xref:jsf-custom/jsf-custom.adoc#_configuring_model_data[Configuring Model Data] describes how the application stores these values.

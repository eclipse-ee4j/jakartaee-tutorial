...
The way this event is handled is explained more in <<_handling_events_for_custom_components>>.
...
How the JavaScript is generated is explained more in <<_performing_encoding>>.
...
<<_creating_the_renderer_class>> explains how to do this in the `AreaRenderer` class.

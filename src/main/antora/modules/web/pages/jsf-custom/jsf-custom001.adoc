[[A1350198]][[_introduction_to_creating_custom_components]]
...
See xref:jsf-custom/jsf-custom.adoc#BNAVK[Component, Renderer, and Tag
...
application. See xref:#GLNVI[Chapter 60, "Duke's

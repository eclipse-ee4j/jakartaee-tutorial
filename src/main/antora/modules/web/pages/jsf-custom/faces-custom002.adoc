...
See xref:jsf-page-core/jsf-page-core.adoc#_using_the_standard_validators[Using the Standard Validators] and xref:jsf-custom/jsf-custom.adoc#_creating_and_using_a_custom_validator[Creating and Using a Custom Validator] for more information about validating a component's data.
...
See xref:jsf-custom/jsf-custom.adoc#_implementing_an_event_listener[Implementing an Event Listener] and xref:jsf-develop/jsf-develop.adoc#_writing_managed_bean_methods[Writing Managed Bean Methods] for more information.

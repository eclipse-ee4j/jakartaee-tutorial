...
xref:jsf-custom/jsf-custom.adoc#_creating_and_using_a_custom_validator[Creating and Using a Custom Validator] explains how to implement the `Validator` interface.

xref:jsf-custom/jsf-custom.adoc#_using_a_custom_validator[Using a Custom Validator] explains how to reference the validator from the page.

[[BNARF]][[_adding_components_to_a_page_using_html_tag_library_tags]]
...
component tags shown in xref:jsf-page/jsf-page.adoc#BNAQH[Table 10-1].
...
xref:jsf-develop/jsf-develop.adoc#BNATX[Chapter 12, "Developing with Jakarta Server Faces
Technology."]
...
following sections, xref:jsf-develop/jsf-develop.adoc#BNATY[Writing Bean
...
xref:jsf-el/jsf-el.adoc#BNAHS[Immediate Evaluation], which uses the `${}`
delimiters. For more information on expression syntax, see
xref:jsf-el/jsf-el.adoc#BNAHV[Value Expressions].

[[BNARI]][[_the_immediate_attribute]]
...
xref:jsf-el/jsf-el.adoc#BNAHU[Value and Method Expressions], these rvalue
...
xref:webi18n/webi18n.adoc#BNAXU[Chapter 22, "Internationalizing and Localizing
Web Applications"].

|=======================================================================


[[BNARK]][[_the_style_and_styleclass_attributes]]

==== The style and styleClass Attributes

The `style` and `styleClass` attributes allow you to specify CSS styles
for the rendered output of your tags. xref:jsf-page/jsf-page.adoc#BNASO[Displaying Error
...
[[BNARL]][[_the_value_and_binding_attributes]]
...
xref:jsf-develop/jsf-develop.adoc#BNAQN[Creating a Managed Bean],
xref:jsf-develop/jsf-develop.adoc#BNATZ[Writing Properties Bound to Component
Values], and xref:jsf-develop/jsf-develop.adoc#BNAUK[Writing Properties Bound to
Component Instances].

[[GJDGQ]][[_adding_html_head_and_body_tags]]
...
xref:jsf-page/jsf-page.adoc#GJGEP[Resource Relocation Using h:outputScript and
h:outputStylesheet Tags].

[[BNARM]][[_adding_a_form_component]]
...
xref:jsf-page/jsf-page.adoc#BNARN[Figure 10-1] shows a typical login form in which a user
...
image::common:jakartaeett_dt_065_frmcmpnt.png[ "Form with User Name and Password text fields and a Login button."]
...
xref:jsf-page/jsf-page.adoc#BNARP[Figure 10-2] shows examples of these text components.

[[BNARP]]

.*Figure 10-2 Example Text Components*
image::common:jakartaeett_dt_068_txtcmpnts.png[ "A form. "User Name" labels a field. "Password" labels a password field. "Comments" labels a multi-line field."]
...
xref:jsf-page/jsf-page.adoc#BNARQ[Table 10-3] lists the tags that represent the input
components.
...
The input tags support the tag attributes shown in xref:jsf-page/jsf-page.adoc#GKCNH[Table
10-4] in addition to those described in xref:jsf-page/jsf-page.adoc#BNARG[Common Component Tag
...
the complete list of attributes, refer to the https://jakarta.ee/specifications/faces/2.3/vdldoc/[Jakarta Server
...
component's local data. See xref:jsf-page-core/jsf-page-core.adoc#BNAST[Using the
...
xref:jsf-page-core/jsf-page-core.adoc#BNATR[Referencing a Method That Performs
...
component. See xref:jsf-page-core/jsf-page-core.adoc#BNATS[Referencing a Method That
Handles a Value-Change Event] for an example of using
`valueChangeListener`.
|=======================================================================


xref:jsf-page/jsf-page.adoc#GJFWE[Table 10-5] lists the tags that represent the output
components.
...
those listed in xref:jsf-page/jsf-page.adoc#BNARG[Common Component Tag Attributes].

The rest of this section explains how to use some of the tags listed in
xref:jsf-page/jsf-page.adoc#GJFWE[Output Tags]. The other tags are
written in a similar way.

[[BNARR]][[_rendering_a_field_with_the_hinputtext_tag]]
...
See xref:#GKCRG[Validating Null and Empty Strings]
for more information.

[[BNARV]][[_rendering_a_password_field_with_the_hinputsecret_tag]]
...
[[BNARS]][[_rendering_a_label_with_the_houtputlabel_tag]]
...
[[BNART]][[_rendering_a_link_with_the_houtputlink_tag]]
...
[[BNARU]][[_displaying_a_formatted_message_with_the_houtputformat_tag]]
...
[[BNARW]][[_using_command_component_tags_for_performing_actions_and_navigation]]
...
In addition to the tag attributes listed in xref:jsf-page/jsf-page.adoc#BNARG[Common Component
...
See xref:jsf-page-core/jsf-page-core.adoc#BNATP[Referencing a Method That Performs
Navigation] for more information on using the `action` attribute. See
xref:jsf-page-core/jsf-page-core.adoc#BNATQ[Referencing a Method That Handles an
Action Event] for details on using the `actionListener` attribute.

[[BNARX]][[_rendering_a_button_with_the_hcommandbutton_tag]]
...
attribute, see xref:jsf-page-core/jsf-page-core.adoc#BNATP[Referencing a Method That
Performs Navigation].

[[GKBUJ]][[_rendering_a_link_with_the_hcommandlink_tag]]
...
[[BNASB]][[_adding_graphics_and_images_with_the_hgraphicimage_tag]]
...
xref:jsf-facelets/jsf-facelets.adoc#GIRGM[Web Resources] to point to the image
...
[[BNASC]][[_laying_out_components_with_the_hpanelgrid_and_hpanelgroup_tags]]
...
xref:jsf-page/jsf-page.adoc#BNASD[Table 10-6] lists the tags used to create panels.
...
information about facets, see xref:jsf-page/jsf-page.adoc#BNARZ[Using Data-Bound Table
Components].

The `h:panelGroup` tag has an attribute, `layout`, in addition to those
listed in xref:jsf-page/jsf-page.adoc#BNARG[Common Component Tag Attributes]. If the `layout`
...
[[BNASE]][[_displaying_components_for_selecting_one_value]]
...
xref:jsf-page/jsf-page.adoc#BNASF[Figure 10-3] shows examples of these components.

[[BNASF]]

.*Figure 10-3 Example Components for Selecting One Item*
image::common:jakartaeett_dt_067_slctn.png[ "Options, check box, and lists."]

[[BNASG]][[_displaying_a_check_box_using_the_hselectbooleancheckbox_tag]]
...
[[BNASH]][[_displaying_a_menu_using_the_hselectonemenu_tag]]
...
representing the items in the list. xref:jsf-page/jsf-page.adoc#BNASK[Using the f:selectItem
and f:selectItems Tags] describes these tags.

[[BNASI]][[_displaying_components_for_selecting_multiple_values]]
...
xref:jsf-page/jsf-page.adoc#BNASJ[Figure 10-4] shows examples of these components.

[[BNASJ]]

.*Figure 10-4 Example Components for Selecting Multiple Values*
image::common:jakartaeett_dt_066_slctmny.png[ "Check box group, scrollable box, and unscrollable box."]
...
[[BNASK]][[_using_the_fselectitem_and_fselectitems_tags]]
...
[[BNASM]][[_using_the_fselectitems_tag]]

==== Using the f:selectItems Tag

The following example from xref:jsf-page/jsf-page.adoc#BNASI[Displaying Components for
...
See xref:jsf-develop/jsf-develop.adoc#BNAUH[UISelectItems Properties] for
information on how to write a managed bean property for one of these
tags.

[[BNASN]][[_using_the_fselectitem_tag]]

==== Using the f:selectItem Tag

The `f:selectItem` tag represents a single item in a list of items. Here
is the example from xref:jsf-page/jsf-page.adoc#BNASH[Displaying a Menu Using the
...
[[sthref50]][[_displaying_the_results_from_selection_components]]
...
join the Duke Fan Club, as described in xref:jsf-page/jsf-page.adoc#BNASG[Displaying a Check
...
xref:jsf-page/jsf-page.adoc#BNASI[Displaying Components for Selecting Multiple Values]. To do
...
list. (This tag is listed in xref:jsf-facelets/jsf-facelets.adoc#GJBFP[Table 8-2].)

[[BNARZ]][[_using_data_bound_table_components]]
...
acceptable types. See xref:jsf-develop/jsf-develop.adoc#BNATY[Writing Bean
...
xref:jsf-page/jsf-page.adoc#GKBUK[Table 10-7] shows the optional attributes for the
`h:dataTable` tag.
...
Each of the attributes in xref:jsf-page/jsf-page.adoc#GKBUK[Table 10-7] can specify more than
...
[[BNASO]][[_displaying_error_messages_with_the_hmessage_and_hmessages_tags]]
...
[[GIQZD]][[_creating_bookmarkable_urls_with_the_hbutton_and_hlink_tags]]
...
[[GIQWQ]][[_using_view_parameters_to_configure_bookmarkable_urls]]
...
[[sthref52]][[_the_bookmarks_example_application]]

=== The bookmarks Example Application

The `bookmarks` example application modifies the `hello1` application
described in xref:webapp/webapp.adoc#BNADX[A Web Module That Uses Jakarta Server
...
xref:jsf-page/jsf-page.adoc#GIQWQ[Using View Parameters to Configure Bookmarkable URLs].
...
[[CHDIEHEB]][[_to_build_package_and_deploy_the_bookmarks_example_using_netbeans_ide]]
...
[[CHDEFJEF]][[_to_build_package_and_deploy_the_bookmarks_example_using_maven]]
...
[[CHDGEBCB]][[_to_run_the_bookmarks_example]]
...
[[GJGEP]][[_resource_relocation_using_houtputscript_and_houtputstylesheet_tags]]
...
tags, see the https://jakarta.ee/specifications/faces/2.3/vdldoc/[Jakarta Server Faces Facelets Tag Library
documentation].

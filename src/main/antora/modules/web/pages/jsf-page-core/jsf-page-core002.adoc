[[BNASZ]][[_registering_listeners_on_components]]
...
Action Event] and xref:jsf-page-core/jsf-page-core.adoc#BNATS[Referencing a Method
...
[[BNATA]][[_registering_a_value_change_listener_on_a_component]]
...
xref:jsf-page-core/jsf-page-core.adoc#GKCLY[Table 11-5], one of which must be used.
...
converter tags. See xref:jsf-custom/jsf-custom.adoc#BNATG[Binding Component
Values and Instances to Managed Bean Properties] for more information.

[[BNATB]][[_registering_an_action_listener_on_a_component]]

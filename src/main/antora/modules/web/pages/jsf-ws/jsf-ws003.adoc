[[_using_the_fwebsocket_tag]]
== Using the f:websocket Tag

xref:jsf-ws/jsf-ws.adoc#_attributes_of_the_f:websocket_tag[Table 17-1] describes the attributes of
the `f:websocket` tag.

[[_attributes_of_the_f:websocket_tag]]

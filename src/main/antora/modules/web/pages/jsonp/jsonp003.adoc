...
[[_creating_an_object_model_from_json_data]]
...
[[_creating_an_object_model_from_application_code]]
...
xref:#BABGHEHG[JSON Syntax].


[[_navigating_an_object_model]]
...
xref:#BABBHEBA[Creating an Object Model from JSON Data] and
xref:#BABIGIAF[Creating an Object Model from Application Code] as
follows:
...
The `navigateTree` method for the model built in xref:#BABIGIAF[Creating
...
[[_writing_an_object_model_to_a_stream]]
=== Writing an Object Model to a Stream

The object models created in xref:#BABBHEBA[Creating an Object Model
from JSON Data] and xref:#BABIGIAF[Creating an Object Model from

[[_the_jsonpstreaming_example_application]]
...
[[_components_of_the_jsonpstreaming_example_application]]
...
similar to the example in xref:#BABGJEEF[Writing JSON Data
Using a Generator]. The code to parse JSON data from a file is similar
to the example in xref:#BABGCHIG[Reading JSON Data Using a
Parser].


[[_running_the_jsonpstreaming_example_application]]
...
[[_to_run_the_jsonpstreaming_example_application_using_netbeans_ide]]
...
[[_to_run_the_jsonpstreaming_example_application_using_maven]]

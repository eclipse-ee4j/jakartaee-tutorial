[[BABCDBBC]][[_the_websocketbot_example_application]]
...
[[CIHICIDE]][[_architecture_of_the_websocketbot_example_application]]
...
* xref:websocket/websocket.adoc#CIHDAEHF[The CDI Bean] – A CDI bean (`BotBean`) that contains
the logic for the bot agent to reply to messages
* xref:websocket/websocket.adoc#CIHJJJHG[The WebSocket Endpoint] – A WebSocket endpoint
(`BotEndpoint`) that implements the chat room
* xref:websocket/websocket.adoc#CIHFDGHG[The Application Messages] – A set of classes
(`Message`, `ChatMessage`, `InfoMessage`, `JoinMessage`, and
`UsersMessage`) that represent application messages
* xref:websocket/websocket.adoc#CIHGHHBD[The Encoder Classes] – A set of classes
...
* xref:websocket/websocket.adoc#CIHHFICG[The Message Decoder] – A class (`MessageDecoder`) the
parses WebSocket text messages as JSON data and decodes them into
`JoinMessage` or `ChatMessage` objects
* xref:websocket/websocket.adoc#CIHHIEFH[The HTML Page] – An HTML page
(`index.html`) that uses JavaScript code to implement the client for the
chat room

[[CIHDAEHF]][[_the_cdi_bean]]
...
[[CIHJJJHG]][[_the_websocket_endpoint]]
...
xref:websocket/websocket.adoc#BABIFBCG[Sending Messages to All Peers Connected
to an Endpoint].
...
[[CIHFDGHG]][[_the_application_messages]]
...
[[CIHHJHDB]][[_running_the_websocketbot_example_application]]
...
[[CIHFDDGE]][[_to_run_the_websocketbot_example_application_using_netbeans_ide]]
...
----
+
See xref:websocket/websocket.adoc#BABDDAAG[To Test the websocketbot Example Application] for
more information.

[[CIHEDEHB]][[_to_run_the_websocketbot_example_application_using_maven]]
...
[[BABDDAAG]][[_to_test_the_websocketbot_example_application]]

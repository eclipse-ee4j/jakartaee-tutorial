[[BABFCGBJ]][[_sending_and_receiving_messages]]
...
xref:websocket/websocket.adoc#BABDGEJH[Table 19-1]. When your message is a
...
The example in xref:websocket/websocket.adoc#BABFEBGA[Annotated Endpoints]
demonstrates how to use this procedure to reply to every incoming text
message.

[[BABIFBCG]][[_sending_messages_to_all_peers_connected_to_an_endpoint]]

...
+
The example application described in <<_the_compositecomponentexample_example_application>> shows how to use a managed bean with a composite component by passing the reference of the managed bean to the component.

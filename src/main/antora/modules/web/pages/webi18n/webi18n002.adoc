[[BNAXW]][[_providing_localized_messages_and_labels]]
...
[[GKUIA]][[_establishing_the_locale]]
...
[[BNAXY]][[_setting_the_resource_bundle]]
...
attribute (see xref:servlets/servlets.adoc#BNAGO[Associating Objects with a
...
[[GKUFC]][[_retrieving_localized_messages]]
...
xref:jsf-page/jsf-page.adoc#BNASO[Displaying Error Messages with the h:message
and h:messages Tags].

...
This resource library can also be loaded explicitly as described in xref:jsf-ajax/jsf-ajax.adoc#_loading_javascript_as_a_resource[Loading JavaScript as a Resource].

[[GKACE]][[_sending_an_ajax_request]]
...
xref:jsf-ajax/jsf-ajax.adoc#GKDER[Table 13-1] to create the Ajax request. The
...
[[GKHVT]][[_using_the_event_attribute]]
...
[[GKHUZ]][[_using_the_execute_attribute]]
...
[[GKHWM]][[_using_the_immediate_attribute]]
...
application (see xref:jsf-facelets/jsf-facelets.adoc#BABGGIAA[The reservation

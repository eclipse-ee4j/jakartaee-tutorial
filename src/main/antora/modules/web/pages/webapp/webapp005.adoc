[[CHDHGJIA]][[_configuring_web_applications]]
...
[[BNAES]][[_setting_context_parameters]]
...
initialization parameters, see xref:servlets/servlets.adoc#BNAFU[Creating and
Initializing a Servlet].

[[GJSFJ]][[_to_add_a_context_parameter_using_netbeans_ide]]
...
the steps in xref:webapp/webapp.adoc#GKIHH[To Create a web.xml File Using NetBeans IDE].
...
[[GKIHH]][[_to_create_a_web.xml_file_using_netbeans_ide]]
...
[[BNAER]][[_declaring_welcome_files]]
...
`_host:port/webapp/directory/_{zwsp}welcome.html` is returned to the
client.
...
[[GKBKW]][[_mapping_errors_to_error_screens]]
...
[[BNAET]][[_to_set_up_error_mapping_using_netbeans_ide]]
...
[[BNAEU]][[_declaring_resource_references]]
...
[[BNAEW]][[_declaring_a_reference_to_a_resource]]
...
[[BNAEX]][[_declaring_a_reference_to_a_web_service]]

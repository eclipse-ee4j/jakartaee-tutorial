...
It is described later in xref:cdi:cdi-adv/cdi-adv.adoc#_using_stereotypes_in_cdi_applications[Using Stereotypes in CDI Applications].
...
For more information on scopes in Jakarta Faces technology, see xref:faces-configure/faces-configure.adoc#_using_managed_bean_scopes[Using Managed Bean Scopes].
...
. Start GlassFish Server as described in xref:intro:usingexamples/usingexamples.adoc#_to_start_glassfish_server_using_netbeans_ide[To Start GlassFish Server Using NetBeans IDE], if you have not already done so.
...
. Start GlassFish Server as described in xref:intro:usingexamples/usingexamples.adoc#_to_start_glassfish_server_using_the_command_line[To Start GlassFish Server Using the Command Line], if you have not already done so.

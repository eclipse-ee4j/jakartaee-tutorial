...
Development of service-oriented web applications is covered in xref:building-web-services-with-jakarta-xml-web-services[] and xref:building-restful-web-services-with-jakarta-rest[] in xref:web-services[]

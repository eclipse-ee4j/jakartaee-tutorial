...
Development of presentation-oriented web applications is covered in xref:faces-intro/faces-intro.adoc#_jakarta_faces_technology[Jakarta Faces Technology] through xref:servlets/servlets.adoc#_jakarta_servlet_technology[Jakarta Servlet Technology]

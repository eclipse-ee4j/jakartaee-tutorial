...
xref:jsf-configure/jsf-configure.adoc#CHDIHDCD[Figure 16-1] shows two flows and illustrates how they
interact.

[[CHDIHDCD]]

.*Figure 16-1 Two Faces Flows and Their Interactions*
image::common:jakartaeett_dt_017.png[ "This figure shows two Faces flows, Flow A and Flow B. Each has a start node and two additional pages. Each has an associated managed bean. Each defines a return node, and each defines two parameters to be passed to the other flow."]
...
[[sthref81]][[_packaging_flows_in_an_application]]
...
shown in xref:jsf-configure/jsf-configure.adoc#CHDIHDCD[Figure 16-1] might look like this:
...
[[sthref82]][[_the_simplest_possible_flow_the_simple_flow_example_application]]
...
[[sthref83]][[_to_build_package_and_deploy_the_simple_flow_example_using_netbeans_ide]]
...
[[sthref84]][[_to_build_package_and_deploy_the_simple_flow_example_using_maven]]
...
[[sthref85]][[_to_run_the_simple_flow_example]]
...
[[sthref86]][[_the_checkout_module_example_application]]
...
Like the hypothetical example in xref:jsf-configure/jsf-configure.adoc#CHDIHDCD[Figure 16-1], the
...
[[sthref87]][[_the_facelets_pages_for_the_checkout_module_example]]
...
[[sthref88]][[_using_a_configuration_file_to_configure_a_flow]]
...
[[sthref89]][[_using_a_java_class_to_configure_a_flow]]
...
[[sthref90]][[_the_flow_scoped_managed_beans]]
...
[[sthref91]][[_to_build_package_and_deploy_the_checkout_module_example_using_netbeans_ide]]
...
[[sthref92]][[_to_build_package_and_deploy_the_checkout_module_example_using_maven]]
...
[[sthref93]][[_to_run_the_checkout_module_example]]

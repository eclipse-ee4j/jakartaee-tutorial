[[BNAWP]][[_application_configuration_resource_file]]
...
[[GIREP]][[_configuring_eager_application_scoped_managed_beans]]
...
[[GIQCK]][[_ordering_of_application_configuration_resource_files]]

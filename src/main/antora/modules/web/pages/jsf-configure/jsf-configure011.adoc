[[BNAXH]][[_registering_a_custom_renderer_with_a_render_kit]]

== Registering a Custom Renderer with a Render Kit

When the application developer creates a custom renderer, as described
in xref:jsf-custom/jsf-custom.adoc#BNAWA[Delegating Rendering to a Renderer], you
...
annotation, as described in xref:jsf-custom/jsf-custom.adoc#BNAWB[Creating the

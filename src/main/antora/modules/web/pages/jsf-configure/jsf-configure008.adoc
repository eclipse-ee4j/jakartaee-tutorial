[[BNAXD]][[_registering_a_custom_validator]]
...
xref:jsf-custom/jsf-custom.adoc#BNAUX[Implementing the Validator Interface], or
...
xref:jsf-custom/jsf-custom.adoc#BNATV[Using a Custom Validator] explains how to

...
As explained in xref:jsf-configure/jsf-configure.adoc#_application_configuration_resource_file[Application Configuration Resource File], an application can have multiple application configuration resource files.

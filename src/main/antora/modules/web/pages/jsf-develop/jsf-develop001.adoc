[[BNAQM]][[_managed_beans_in_javaserver_faces_technology]]
...
in Web Pages"] and xref:jsf-page-core/jsf-page-core.adoc#GJCUT[Chapter 11, "Using
...
[[BNAQN]][[_creating_a_managed_bean]]
...
again. See xref:jsf-develop/jsf-develop.adoc#BNATY[Writing Bean Properties] for
...
xref:jsf-develop/jsf-develop.adoc#BNATY[Writing Bean Properties].

[[BNAQP]][[_using_the_el_to_reference_managed_beans]]
...
xref:jsf-el/jsf-el.adoc#BNAHQ[Overview of the EL], the following are some of
...
For information on the EL, see xref:jsf-el/jsf-el.adoc#GJDDD[Chapter 9,
"Expression Language"].

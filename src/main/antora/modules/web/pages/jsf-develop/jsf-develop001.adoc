...
See xref:jsf-develop/jsf-develop.adoc#_writing_bean_properties[Writing Bean Properties] for information on which types are accepted by which component tags.
...
For more information on writing beans and their properties, see xref:jsf-develop/jsf-develop.adoc#_writing_bean_properties[Writing Bean Properties].

[[BNATY]][[_writing_bean_properties]]

== Writing Bean Properties


As explained in xref:jsf-develop/jsf-develop.adoc#BNAQM[Managed Beans in
Jakarta Server Faces Technology], a managed bean property can be bound to
...
bean properties. See xref:jsf-custom/jsf-custom.adoc#BNATG[Binding Component
Values and Instances to Managed Bean Properties] and
xref:jsf-custom/jsf-custom.adoc#BNATM[Binding Converters, Listeners, and
...
objects described in xref:jsf-page/jsf-page.adoc#BNARF[Adding Components to a
Page Using HTML Tag Library Tags], and to converter, listener, and
validator implementations.

[[BNATZ]][[_writing_properties_bound_to_component_values]]
...
xref:jsf-develop/jsf-develop.adoc#BNAUA[Table 12-1] lists the `javax.faces.component` classes and
...
[[BNAUB]][[_uiinput_and_uioutput_properties]]
...
As described in xref:jsf-page-core/jsf-page-core.adoc#BNAST[Using the Standard
...
xref:jsf-page-core/jsf-page-core.adoc#BNASV[Using DateTimeConverter], that displays
...
types listed in xref:jsf-develop/jsf-develop.adoc#BNAUA[Table 12-1]. Data components are discussed
in xref:jsf-page/jsf-page.adoc#BNARZ[Using Data-Bound Table Components]. Here
...
[[BNAUD]][[_uiselectboolean_properties]]
...
xref:jsf-page/jsf-page.adoc#BNASE[Displaying Components for Selecting One
...
[[BNAUE]][[_uiselectmany_properties]]
...
xref:jsf-page/jsf-page.adoc#BNASI[Displaying Components for Selecting Multiple
Values]:
...
xref:jsf-page/jsf-page.adoc#BNASH[Displaying a Menu Using the h:selectOneMenu
Tag]:
...
[[BNAUG]][[_uiselectitem_properties]]
...
The example `selectOneMenu` tag from xref:jsf-develop/jsf-develop.adoc#BNAUF[UISelectOne Properties]
...
[[BNAUH]][[_uiselectitems_properties]]
...
[[BNAUK]][[_writing_properties_bound_to_component_instances]]]
...
xref:jsf-develop/jsf-develop.adoc#BNAQM[Managed Beans in Jakarta Server Faces
Technology].

For information on how to reference a managed bean method that performs
navigation when a button is clicked, see
xref:jsf-page-core/jsf-page-core.adoc#BNATP[Referencing a Method That Performs
Navigation].

For more information on writing managed bean methods that handle
navigation, see xref:jsf-develop/jsf-develop.adoc#BNAVC[Writing a Method to Handle
Navigation].

[[BNAUL]][[_writing_properties_bound_to_converters_listeners_or_validators]]

[[BNAQD]][[_user_interface_component_model]]
...
xref:jsf-custom/jsf-custom.adoc#BNAVG[Chapter 15, "Creating Custom UI Components and
...
[[BNAQF]][[_component_rendering_model]]
...
The section xref:jsf-page/jsf-page.adoc#BNARF[Adding Components to a Page Using
...
converter creation is covered in xref:jsf-custom/jsf-custom.adoc#BNAVG[Chapter 15,
"Creating Custom UI Components and Other Custom Objects"].

[[GIREH]][[_event_and_listener_model]]
...
xref:jsf-page/jsf-page.adoc#BNARI[The immediate Attribute]) of the component
...
See xref:jsf-custom/jsf-custom.adoc#BNAUT[Implementing an Event Listener] for
information on how to implement an event listener. See
xref:jsf-page-core/jsf-page-core.adoc#BNASZ[Registering Listeners on Components] for
information on how to register the listener on a component.

See xref:jsf-develop/jsf-develop.adoc#BNAVD[Writing a Method to Handle an Action
Event] and xref:jsf-develop/jsf-develop.adoc#BNAVF[Writing a Method to Handle a
Value-Change Event] for information on how to implement managed bean
methods that handle these events.

See xref:jsf-page-core/jsf-page-core.adoc#BNATN[Referencing a Managed Bean Method]
...
method that handles the event. xref:jsf-custom/jsf-custom.adoc#BNAWD[Handling
Events for Custom Components] explains how to do this.

[[BNAQK]][[_validation_model]]
...
implementations. See xref:jsf-page-core/jsf-page-core.adoc#BNATC[Using the Standard
...
validators, see xref:jsf-configure/jsf-configure.adoc#GIREB[Using Default
Validators].
...
xref:#CHDGJIIA[Chapter 23, "Introduction to Bean
Validation"] and xref:#GKAHP[Chapter 24,

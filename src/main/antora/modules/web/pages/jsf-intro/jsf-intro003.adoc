...
For more information on Facelets technology features, see xref:jsf-facelets/jsf-facelets.adoc#_introduction_to_facelets[Introduction to Facelets].
...
In addition, implicit navigation rules allow developers to quickly configure page navigation (see xref:jsf-intro/jsf-intro.adoc#_navigation_model[Navigation Model] for details).

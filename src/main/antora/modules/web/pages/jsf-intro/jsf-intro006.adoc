...
navigation, see xref:jsf-develop/jsf-develop.adoc#BNAVD[Writing a Method to Handle
an Action Event].

For more information on how to reference outcomes or action methods from
component tags, see xref:jsf-page-core/jsf-page-core.adoc#BNATP[Referencing a Method

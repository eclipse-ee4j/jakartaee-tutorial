[[BEIGCFDF]][[_asynchronous_processing]]
...
[[sthref103]][[_asynchronous_processing_in_servlets]]
...
xref:servlets/servlets.adoc#BEICFIEC[Table 18-3] describes the basic functionality provided by
...
[[sthref105]][[_waiting_for_a_resource]]

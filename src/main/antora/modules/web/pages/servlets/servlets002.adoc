...
.. Initializes the servlet instance by calling the `init` method (initialization is covered in xref:servlets/servlets.adoc#_creating_and_initializing_a_servlet[Creating and Initializing a Servlet])

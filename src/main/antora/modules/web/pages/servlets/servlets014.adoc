[[BEIJHCDJ]][[_protocol_upgrade_processing]]
...
described in xref:servlets/servlets.adoc#BEIBDHAG[Table 18-7].
...
connection. You can use xref:servlets/servlets.adoc#BEIHICDH[Nonblocking I/O]

...
See xref:websocket/websocket.adoc#_the_dukeetf2_example_application[The dukeetf2 Example Application] in xref:jakarta-websocket-2[] for an equivalent version of this example implemented using a WebSocket endpoint.

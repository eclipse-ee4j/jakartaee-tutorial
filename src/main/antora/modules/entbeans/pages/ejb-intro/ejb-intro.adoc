...
Enterprise beans run in the Enterprise Bean container, a runtime environment within GlassFish Server (see xref:intro:overview/overview.adoc#_container_types[Container Types]).

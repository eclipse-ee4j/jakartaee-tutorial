...
Interfaces are described in the section <<_accessing_enterprise_beans>>.
...
For more information, see <<receiving-messages-asynchronously-using-a-message-driven-bean>> and xref:transactions[].

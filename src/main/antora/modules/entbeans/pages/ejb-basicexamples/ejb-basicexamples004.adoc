...
This method matches the `sayHello` method invoked by the client described in xref:websvcs:jaxws/jaxws.adoc#_a_simple_xml_web_services_application_client[A Simple XML Web Services Application Client].
...
See the list of Jakarta XML Binding default data type bindings at xref:websvcs:jaxws/jaxws.adoc#_types_supported_by_xml_web_services[Types Supported by XML Web Services].

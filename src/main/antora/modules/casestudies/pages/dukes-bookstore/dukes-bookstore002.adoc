...
The properties files, located in the `_jakartaee-examples_/tutorial/case-studies/dukes-bookstore/src/main/java/ee/jakarta/tutorial/dukesbookstore/web/messages/` directory, consist of a default file containing English strings and three additional files for other locales.

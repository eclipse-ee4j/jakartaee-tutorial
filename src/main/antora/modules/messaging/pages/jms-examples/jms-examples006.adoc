...
This section assumes that you are familiar with the basics of Jakarta Faces technology, described in the xref:web:jsf-intro/jsf-intro.adoc#_introduction_to_jakarta_faces_technology[Introduction to Jakarta Faces Technology]

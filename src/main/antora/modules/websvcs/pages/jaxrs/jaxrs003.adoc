...
You can find a version of this application at `_jakartaee-examples_/tutorial/jaxrs/hello/`.
...
The `rsvp` example application, located in the `_jakartaee-examples_/tutorial/jaxrs/rsvp/` directory, allows invitees to an event to indicate whether they will attend.
